...
public class Perms {
    ...
    public static final String PREFIX          = "excellenteconomy.";
    ...
    public static final UniPermission HIDE_FROM_TOPS = new UniPermission(PREFIX +
        "hidefromtops", PermissionDefault.FALSE);

    public static final UniPermission COMMAND_CURRENCY_BALANCE         = new UniPermission(PREFIX_COMMAND +
        "currency.balance");
    public static final UniPermission COMMAND_CURRENCY_BALANCE_OTHERS  = new UniPermission(PREFIX_COMMAND +
        "currency.balance.others");
    public static final UniPermission COMMAND_CURRENCY_EXCHANGE        = new UniPermission(PREFIX_COMMAND +
        "currency.exchange");
    public static final UniPermission COMMAND_CURRENCY_GIVE            = new UniPermission(PREFIX_COMMAND +
        "currency.add");
